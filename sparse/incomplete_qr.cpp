...
static void copy_column(int colstart, int nextcolstart, const unsigned int *rowindex, const double *value,
...
void incomplete_qr(int m, int n, const unsigned int *Acolstart, const unsigned int *Arowindex, const double *Avalue,
                   double Qdroptol,
                   const unsigned int *Rcolstart, const unsigned int *Rrowindex, double *Rvalue, double *Rdiag)
{
   ...
   for(int i=0; i<n; ++i){
      for(unsigned int a=Rcolstart[i]; a<Rcolstart[i+1]; ++a){
         int j=Rrowindex[a];
